...
app.use('/api', postsRoute); //everytime we go to api the above specified postRoutes are going to run //work as our middleware
...
app.listen(3000);//the port that we are listening on  make sure it's not being in used already
